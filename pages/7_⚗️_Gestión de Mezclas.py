...
st.title("⚗️ Gestión de Mezclas por Lote")
st.write("El ingeniero programa la receta seleccionando lotes específicos y el encargado confirma la preparación para registrar la salida del inventario.")
